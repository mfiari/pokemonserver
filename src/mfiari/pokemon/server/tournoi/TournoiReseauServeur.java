...
import mfiari.pokemon.core.tournoi.Groupe;
 ...
 * @author mike
 */
public class TournoiReseauServeur extends Tournoi {
    ...
    public TournoiReseauServeur (ListeDeDresseur participants) {
        this.terrain = Terrains.tousTerrain;
        this.nom = "Ligue Pokemon";
    ...
    public TournoiReseauServeur (ListeDeDresseur participants, ListeDeDresseur persos, ListeDeDresseur persosReseaux, Socket socket, 
    ...
    public void commencerTournoi () {
        ...
        switch (this.nbParticipant) {
            case 8:
                ...
                //this.envoi.writeObject(this.quart);
                this.quartFinal();
                break;
            case 16:
                ...
                //this.envoi.writeObject(this.huitieme);
                this.huitiemeFinal();
                break;
            case 32 :
                ...
                //this.envoi.writeObject(this.poule);
                this.poule();
                break;
        }
    }
    ...
    private void tour (Groupe groupe) {
        ...
        this.choixTerrain();
        this.envoi.writeObject(this.terrainDuCombat);
        ...
        } else if (this.dresseurReseau.contains(this.dress1) || this.dresseurReseau.contains(this.dress2)) {
    ...
    private void choixPokemonAdversaire (Dresseur dress) {
        ...
        System.out.println("1." + dress.getNom() + " : " + equipe.getNbPokemon() + ", " + equipe.lenght());
        int tour = 0;
        int indice = 0;
        ...
        System.out.println("2." + dress.getNom() + " : " + equipe.getNbPokemon() + ", " + equipe.lenght());
