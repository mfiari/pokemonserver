 ...
 * @author mike
 */
public class PokemonLegendaireNiv1 extends PokemonLegendaire {
    
    public PokemonLegendaireNiv1(String nom, int numero, Type type1, Type type2, double taille, double poids, int tauxCapture, 
    ...
    public PokemonLegendaireNiv1 (PokemonLegendaireNiv1 pk) {
        super(pk);
    }
    ...
    public void ajouterEndroits (Endroit e, int nivMin, int nivMax, Environnement environnement, int pourcentage) {
        for (int i = nivMin ; i<=nivMax ; i++) {
            PokemonLegendaire pk = new PokemonLegendaireNiv1(this);
            pk.changeNiveau(i);
